...
Get-Content .\Windows10\Administrators\currentAdministrators.txt | sort | get-unique > .\Windows10\Administrators\sortedCurrentAdministrators.txt
Get-Content .\Windows10\Administrators\competitionAdministrators.txt | sort | get-unique > .\Windows10\Administrators\sortedCompetitionAdministrators.txt
